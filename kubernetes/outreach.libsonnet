  ...
  ALBIngress(
    ...
    metadata+: {
      annotations+: {
        ...
        'alb.ingress.kubernetes.io/load-balancer-attributes': 'routing.http.drop_invalid_header_fields.enabled=true,access_logs.s3.enabled=true,access_logs.s3.bucket=outreach-aws-lb-controller-logs-%s,access_logs.s3.prefix=%s,idle_timeout.timeout_seconds=%s,load_balancing.cross_zone.enabled=false' % [cluster.region, groupName, idleTimeoutSeconds],
